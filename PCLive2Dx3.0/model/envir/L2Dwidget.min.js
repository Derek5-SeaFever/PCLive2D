...
var L2Dwidget = function(t) {
	...
	e(4).inspectSource = function(t) {
		...
		a && (i(e, "name") || o(e, "name", n)), t[n] !== e && (a && (i(e, c) || o(e, c, t[n] ? "" + t[n] : f.join(String(
	...
	var r = e(1),
		...
		f = function(t, n, e) {
			var s, l, p, v, d = t & f.F,
				...
				g = x[a] || (x[a] = {});
			h && (e = n);
			for (s in e) p = ((l = !d && m && void 0 !== m[s]) ? m : e)[s], v = w && l ? u(p, r) : b && "function" == typeof p ?
				u(Function.call, p) : p, m && c(m, s, p, t & f.U), x[s] != p && i(x, s, v), b && g[s] != p && (g[s] = p)
		};
	...
	t.exports = function(t, n, e, y, b, w, m) {
		...
		if (M && (_ = l(M.call(new t))) !== Object.prototype && _.next && (s(_, O, !0), r || u(_, p) || c(_, p, h)), P &&
			T && T.name !== d && (k = !0, L = function() {
				return T.call(this)
	...
	p && v || (p = function(t) {
			...
			h.now(c(m, t, 1))
		} : d ? (i = (o = new d).port2, o.port1.onmessage = x, r = c(i.postMessage, i, 1)) : s.addEventListener &&
		"function" == typeof postMessage && !s.importScripts ? (r = function(t) {
			s.postMessage(t + "", "*")
	...
	t.exports = function(t) {
		return function(n, e) {
			var i, c, u = String(o(n)),
				a = r(e),
				f = u.length;
			return a < 0 || a >= f ? t ? "" : void 0 : (i = u.charCodeAt(a)) < 55296 || i > 56319 || a + 1 === f || (c = u.charCodeAt(
	...
	var r = e(2),
		...
		f = function() {
			...
			for (n.style.display = "none", e(36).appendChild(n), n.src = "javascript:", (t = n.contentWindow.document).open(),
				t.write("<script>document.F=Object<\/script>"), t.close(), f = t.F; r--;) delete f[a][i[r]];
			return f()
		};
	...
	for (var r = e(69), o = e(33), i = e(5), c = e(1), u = e(3), a = e(9), f = e(0), s = f("iterator"), l = f(
			"toStringTag"), p = a.Array, v = {
			CSSRuleList: !0,
				...
				w(function() {
					for (var r = t._v, o = 1 == t._s, i = 0, c = function(n) {
							var e, i, c = o ? n.ok : n.fail,
								...
								f = n.domain;
							try {
								c ? (o || (2 == t._h && C(t), t._h = 1), !0 === c ? e = r : (f && f.enter(), e = c(r), f && f.exit()), e ===
									n.promise ? a(j("Promise-chain cycle")) : (i = E(e)) ? i.call(e, u, a) : u(e)) : a(r)
							} catch (t) {
								a(t)
							}
						}; e.length > i;) c(e[i++]);
	...
	L || (P = function(t) {
		...
		then: function(t, n) {
			var e = T(y(this, P));
			return e.ok = "function" != typeof t || t, e.fail = "function" == typeof n && n, e.domain = k ? O.domain :
		...
		f = new(function() {
			...
			return o(t, [{
				...
				value: function() {
					...
					(0, u.configApplyer)(t), !u.config.mobile.show && c.default.mobile() || e.e(0).then(e.bind(null, 131)).then(
						function(t) {
							(a = t).theRealInit()
						}).catch(function(t) {
						console.error(t)
	...
	var u = window.document.documentElement,
		...
		f = ["googletv", "viera", "smarttv", "internet.tv", "netcast", "nettv", "appletv", "boxee", "kylo", "roku",
	...
	Object.prototype.hasOwnProperty.call(window, "onorientationchange") && (y = "onorientationchange"), window.addEventListener ?
		window.addEventListener(y, d, !1) : window.attachEvent ? window.attachEvent(y, d) : window[y] = d, d();
	...
	i.type = b(["mobile", "tablet", "desktop"]), i.os = b(["ios", "iphone", "ipad", "ipod", "android", "blackberry",
	...
	a.prototype.clear = r, a.prototype.delete = o, a.prototype.get = i, a.prototype.has = c, a.prototype.set = u, t.exports =
		a
}, function(t, n) {
	t.exports = function() {
		...
		if (j) r(t, e, j);
			...
			if (P) {
				var k = f(_),
					S = !k && l(_),
					T = !k && !S && h(_);
				O = _, k || S || T ? f(g) ? O = g : s(g) ? O = c(g) : S ? (P = !1, O = o(_, !0)) : T ? (P = !1, O = i(_, !0)) :
					O = [] : d(_) || a(_) ? (O = g, a(g) ? O = y(g) : (!v(g) || b && p(g)) && (O = u(_))) : P = !1
			}
	...
	t.exports = function(t) {
		return r(function(n, e) {
			var r = -1,
				...
				c = i > 1 ? e[i - 1] : void 0,
				u = i > 2 ? e[2] : void 0;
			for (c = t.length > 3 && "function" == typeof c ? (i--, c) : void 0, u && o(e[0], e[1], u) && (c = i < 3 ?
					void 0 : c, i = 1), n = Object(n); ++r < i;) {
				var a = e[r];
				a && t(n, a, r, c)
			}
			return n
